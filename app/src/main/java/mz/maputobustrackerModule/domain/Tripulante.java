...
public class Tripulante implements Serializable{
    public static String PROVIDER = "mz.maputobustracker.domain.Tripulante.PROVIDER";
    ...
    public void saveDB( DatabaseReference.CompletionListener... completionListener ){
        DatabaseReference firebase = LibraryClass.getFirebase().child("operadores").child( getId() );
